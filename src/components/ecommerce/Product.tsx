...
const Product = () => {
  ...
  const handleData = async () => {
    const products = await swapContract.methods.getAllProducts().call()
          ...
          <div className="relative">
            <div className="aspect-w-1 aspect-h-1">
              ...
              <img
                ...
                src={`https://${item.imageCid}.ipfs.w3s.link/coverimage.png`}
            ...
            <div className="px-6 py-4 flex-1 flex flex-col">
              ...
              <div className="flex items-center mt-2.5">
                <div className="flex items-center space-x-px"></div>
              </div>
